...
migration-up:
	migrate -path ./migrations/postgres -database 'postgres://bahodir:1100@0.0.0.0:5432/tg_go_coins_service?sslmode=disable' up

migration-down:
	migrate -path ./migrations/postgres -database 'postgres://bahodir:1100@0.0.0.0:5432/tg_go_coins_service?sslmode=disable' down
