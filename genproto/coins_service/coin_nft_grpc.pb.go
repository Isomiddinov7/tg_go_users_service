...
func (c *coinNFTServiceClient) Create(ctx context.Context, in *CoinNFTCreate, opts ...grpc.CallOption) (*CoinNFT, error) {
	...
	out := new(CoinNFT)
	err := c.cc.Invoke(ctx, CoinNFTService_Create_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *coinNFTServiceClient) GetById(ctx context.Context, in *CoinNFTPrimaryKey, opts ...grpc.CallOption) (*CoinNFT, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CoinNFT)
	err := c.cc.Invoke(ctx, CoinNFTService_GetById_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *coinNFTServiceClient) Update(ctx context.Context, in *CoinNFTUpdate, opts ...grpc.CallOption) (*CoinNFT, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CoinNFT)
	err := c.cc.Invoke(ctx, CoinNFTService_Update_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *coinNFTServiceClient) GetList(ctx context.Context, in *GetListCoinNFTRequest, opts ...grpc.CallOption) (*GetListCoinNFTResponse, error) {
	...
	err := c.cc.Invoke(ctx, CoinNFTService_GetList_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *coinNFTServiceClient) Delete(ctx context.Context, in *CoinNFTPrimaryKey, opts ...grpc.CallOption) (*Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Empty)
	err := c.cc.Invoke(ctx, CoinNFTService_Delete_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedCoinNFTServiceServer must be embedded to have
...
func (UnimplementedCoinNFTServiceServer) testEmbeddedByValue()                        {}
...
func RegisterCoinNFTServiceServer(s grpc.ServiceRegistrar, srv CoinNFTServiceServer) {
	// If the following call pancis, it indicates UnimplementedCoinNFTServiceServer was
