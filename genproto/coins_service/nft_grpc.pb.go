...
func (c *nFTServiceClient) Create(ctx context.Context, in *CreateNFT, opts ...grpc.CallOption) (*NFT, error) {
	...
	out := new(NFT)
	err := c.cc.Invoke(ctx, NFTService_Create_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *nFTServiceClient) GetById(ctx context.Context, in *NFTPrimaryKey, opts ...grpc.CallOption) (*NFT, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(NFT)
	err := c.cc.Invoke(ctx, NFTService_GetById_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *nFTServiceClient) Update(ctx context.Context, in *UpdateNFT, opts ...grpc.CallOption) (*NFT, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(NFT)
	err := c.cc.Invoke(ctx, NFTService_Update_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *nFTServiceClient) GetAll(ctx context.Context, in *GetListNFTRequest, opts ...grpc.CallOption) (*GetListNFTResponse, error) {
	...
	err := c.cc.Invoke(ctx, NFTService_GetAll_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *nFTServiceClient) Delete(ctx context.Context, in *NFTPrimaryKey, opts ...grpc.CallOption) (*Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Empty)
	err := c.cc.Invoke(ctx, NFTService_Delete_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedNFTServiceServer must be embedded to have
...
func (UnimplementedNFTServiceServer) testEmbeddedByValue()                    {}
...
func RegisterNFTServiceServer(s grpc.ServiceRegistrar, srv NFTServiceServer) {
	// If the following call pancis, it indicates UnimplementedNFTServiceServer was
